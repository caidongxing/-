...
%>
  ...
  <tr align="center" bgcolor="#e3F4F7">
    <td width="17%" bgcolor="#0080ff">条形码</td>  
    <td width="31%" bgcolor="#0080ff">图书名称</td>
    <td width="18%" bgcolor="#0080ff">图书类型</td>
    <td width="19%" bgcolor="#0080ff">出版社</td>
    <td width="15%" bgcolor="#0080ff">书架</td>
    </tr>
<%
  while(it.hasNext()){
