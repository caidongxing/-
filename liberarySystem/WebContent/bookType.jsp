...
<td width="18%" align="right">
  ...
  <table width="91%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#0080c0" bordercolorlight="#FFFFFF">
  <tr align="center" bgcolor="#e3F4F7">
    <td width="35%" bgcolor="#0080ff">图书类型名称</td>
    <td width="35%" bgcolor="#0080ff">可借天数</td>
