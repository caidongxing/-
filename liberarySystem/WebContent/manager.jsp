...
<td width="16%">
  ...
  <table width="91%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#0080ff" bordercolorlight="#FFFFFF">
  <tr align="center" bgcolor="#e3F4F7">
    <td width="26%" bgcolor="#0080ff">管理员名称</td>
    <td width="12%" bgcolor="#0080ff">系统设置</td>
    <td width="12%" bgcolor="#0080ff">读者管理</td>
    <td width="12%" bgcolor="#0080ff">图书管理</td>
    <td width="11%" bgcolor="#0080ff">图书借还</td>
    <td width="10%" bgcolor="#0080ff">系统查询</td>
    <td width="9%" bgcolor="#0080ff">权限设置</td>
    <td width="8%" bgcolor="#0080ff">删除</td>
  </tr>
<%
  while(it.hasNext()){
