...
<td width="13%">
  ...
  <table width="95%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#0080ff" bordercolorlight="#FFFFFF">
  <tr align="center" bgcolor="#e3F4F7">
    <td width="13%" bgcolor="#0080ff">条形码</td>  
    <td width="10%" bgcolor="#0080ff">姓名</td>
    <td width="8%" bgcolor="#0080ff">读者类型</td>
    <td width="12%" bgcolor="#0080ff">证件类型</td>
    <td width="20%" bgcolor="#0080ff">证件号码</td>
    <td width="12%" bgcolor="#0080ff">电话</td>
    <td width="15%" bgcolor="#0080ff">Email</td>
    <td width="5%" bgcolor="#0080ff">修改</td>
    <td width="5%" bgcolor="#0080ff">删除</td>
  </tr>
<%
  while(it.hasNext()){
