...
<table width="778"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      <tr bgcolor="#0080ff">
        <td width="3%" height="27" bgcolor="#0080ff">&nbsp;</td>
        <td width="29%" bgcolor="#0080ff"><div id="bgclock" class="word_white"></div></td>
        ...
        <td width="66%" align="right" bgcolor="#0080ff" class="word_white"><a href="main.jsp" class="word_white">首页</a> |
