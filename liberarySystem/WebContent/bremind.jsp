...
%>
  ...
  <tr align="center" bgcolor="#e3F4F7">
    <td width="15%" bgcolor="#0080ff">图书条形码</td>
    <td width="28%" bgcolor="#0080ff">图书名称</td>
    <td width="17%" bgcolor="#0080ff">读者条形码</td>
    <td width="9%" bgcolor="#0080ff">读者名称</td>
    <td width="15%" bgcolor="#0080ff">借阅时间</td>
    <td width="16%" bgcolor="#0080ff">应还时间</td>
    </tr>
<%
  while(it.hasNext()){
