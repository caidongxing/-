      ...
      <tr>
		...
		<form name="myform" method="post" action="borrow?action=borrowQuery">
          <table width="98%" height="67"  border="0" cellpadding="0" cellspacing="0" bgcolor="#E3F4F7" class="tableBorder_gray">
            <tr>
              <td rowspan="2" align="center" bgcolor="#0080ff">&nbsp;<img src="Images/search.gif" width="45" height="28"></td>
              <td height="29" bgcolor="#0080ff"><input name="flag" type="checkbox" class="noborder" value="a" checked>
                请选择查询依据：
...
%>
  ...
  <tr align="center" bgcolor="#e3F4F7">
    <td width="11%" bgcolor="#0080ff">图书条形码</td>
    <td width="29%" bgcolor="#0080ff">图书名称</td>
    <td width="15%" bgcolor="#0080ff">读者条形码</td>
    <td width="13%" bgcolor="#0080ff">读者名称</td>
    <td width="12%" bgcolor="#0080ff">借阅时间</td>
    <td width="12%" bgcolor="#0080ff">应还时间</td>
    <td width="8%" bgcolor="#0080ff">是否归还</td>
  </tr>
<%
  while(it.hasNext()){
