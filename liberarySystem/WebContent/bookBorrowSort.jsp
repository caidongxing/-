...
%>
 ...
 <table width="98%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#0080ff" bordercolorlight="#FFFFFF">
  ...
  <td width="8%" bgcolor="#0080ff">借阅次数</td>
    <td width="11%" bgcolor="#0080ff">图书条形码</td>
    <td width="17%" bgcolor="#0080ff">图书名称</td>
    <td width="15%" bgcolor="#0080ff">图书类型</td>
    <td width="16%" bgcolor="#0080ff">书架</td>
    <td width="14%" bgcolor="#0080ff">出版社</td>
    <td width="11%" bgcolor="#0080ff">作者</td>
    <td colspan="2" bgcolor="#0080ff">定价(元)</td>
    </tr>
<%
  while(it.hasNext()){
