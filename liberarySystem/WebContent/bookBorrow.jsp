...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
	...
	<form name="form1" method="post" action="borrow?action=bookborrow">
      ...
      <tr>
        <td height="72" align="center" valign="top" background="Images/main_booksort_1.gif" bgcolor="#0080ff"><table width="96%" border="0" cellpadding="1" cellspacing="0" bordercolor="#FFFFFF" bgcolor="#0080ff">
          <tr>
            <td valign="top" bgcolor="#0080ff"><%
int ID=0;
String name="";
String sex="";
String barcode="";
...
<input name="inputkey" type="text" id="inputkey" size="50">
  ...
  <input name="Button" type="button" class="btn_grey" value="完成借阅" onClick="window.location.href='bookBorrow.jsp'">
          ...
          <tr>
            <td valign="top" bgcolor="#FCEC9A" style="padding:5px"><table width="99%" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#0080ff" bgcolor="#FFFFFF">
