...
import com.hy.dao.AccountitemsMapper;
import com.hy.po.Accountitems;
import com.hy.service.AccountitemsService;

@Transactional
@Service("accountitemsService")
public class AccountitemsServiceImpl extends BaseServiceImpl<Accountitems> implements AccountitemsService {
	...
	public void setBaseMapper(){
		super.setBaseMapper(accountitemsMapper);
	}
}
