					...
					<div class='box-content'>
						...
						<div class="row-fluid">
								<div class="pull-right">
									...
									<a class="btn btn-warning" onclick="GoBackList('${ctx}/resideClientController/list.do')"><i class="icon-remove"></i><span>关闭</span>
									</a>
								</div>
							</div>
						</form>
...
function saveClientinfo(){
    $.ajax({
	    cache: true,
        type: "POST",
        url : '${ctx}/resideClientController/saveClientinfo.do',
