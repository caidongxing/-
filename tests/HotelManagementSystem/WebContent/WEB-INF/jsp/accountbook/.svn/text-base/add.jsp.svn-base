							...
							<div class='control-group'>
								<div class='span6'>
									<label class='span2' style="line-height: 30px">账本代码:</label> <input
										class='span8' name="accountbookcode" type="text"
										placeholder="账本代码" required />
								</div>

								<div class='span6'>
									<label class='span2' style="line-height: 30px">账本名称:</label> <input
										class='span8' name="accountbookname" type="text"
							...
							<div class='control-group'>
								<div class='span6'>
									<label class='span2' style="line-height: 30px">限额:</label> <input
										class='span8' name="quota" type="number" placeholder="限额"
										required />
								</div>
									...
									<div class='box-content box-no-padding'>
										...
										<div class='span4 box bordered-box blue-border'>
											...
											<div class='box-content box-no-padding'
												...
												<ul class='unstyled' id="accountbook"></ul>
											</div>
										</div>
...
function addAccountbook(){
   ...
   for(var i =0;i<items.length;i++){
    ...
    $.ajax({
	    cache: true,
        type: "POST",
        url : '${ctx}/accountBookController/save.do?accountitems=' + accountitems,
