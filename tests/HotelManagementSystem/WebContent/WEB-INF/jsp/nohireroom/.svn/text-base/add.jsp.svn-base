           ...
           <div class="span12">
			...
			<div class="span12" style="border-style: groove;border-bottom: aliceblue;border-left: aliceblue;border-right: aliceblue;margin-top: 10px;"></div>
				<div class="pull-right">
					...
					<button type="button" class="btn btn-danger" onclick="GoBackList('${ctx}/roomStatusController/nohireList.do?roomstatus=4')"> <i class="icon-remove"></i><span>关闭</span></button>
			    </div>
			</div>
...
function nohireAdd(){
  ...
  if(yixuan <= 0){
    ...
    $.ajax({
	    cache: true,
        type: "POST",
        url : '${ctx}/roomStatusController/nohireAdd.do?ckValue=' + roomsid,
